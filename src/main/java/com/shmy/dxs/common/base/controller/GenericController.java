...
public abstract class GenericController<T, Q extends QueryBase> {
    ...
    public Map<String,Object> save(T entity) throws Exception{
        if(entity instanceof SysUser){
            ((SysUser) entity).setPassWord(new Md5PasswordEncoder().encodePassword(((SysUser) entity).getPassWord(),"dxs"));
        }
